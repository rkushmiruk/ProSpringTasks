...
public class HierarchicalContextUsage {
    ...
    public static void main(String[] args) {
        ...
        parentContext.load("chapter03/META-INF/spring/hierarchicalcontext/parent-app-context-xml.xml");
        parentContext.refresh();

        GenericXmlApplicationContext childContext = new GenericXmlApplicationContext();
        childContext.load("chapter03/META-INF/spring/hierarchicalcontext/child-app-context-xml.xml");
